  ...
  .done( function(data){                                 // SERVER RETURNS DATA
      ...
      $("#btn" + key).on('click', function () {
        ...
        $("#slide" + key).show();
  		...
  		$('#slide' + key).css("background", "url(" + val.image + ") bottom center no-repeat");
      $('#slide' + key).hide();
    ...
    $("#prev").on ('click', function () {
        ...
        if (i < 1) {
            $(".slide:visible").hide();
            $(".slide:last").slideDown().show();        
        } else {
            $(".slide:visible").hide().prev(".slide").slideDown();
        };
    ...
    $("#next").on ('click', function () {
        ...
        if (i < len) {
                    $(".slide:visible").slideUp().next(".slide").show();
        } else {
